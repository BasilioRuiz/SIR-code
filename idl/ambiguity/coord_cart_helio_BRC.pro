pro coord_cart_helio_BRC,r0,l0,b0,p,x,y,l,b

; INPUTS 
;          r0      : Semidiameter of disk (sec).
;          l0      : Longitude at center of disk (deg).
;          b0      : Latitude at center of disk (deg).
;          p       : Position angle of rotation axis (deg).
;          x,y     : coordinate in arcsecs relative to Sun center 
...
;eph     =get_sun(timeobs)
;r0      =eph(1)         ; Semidiameter of disk (sec).
;l0      =eph(10)        ; Longitude at center of disk (deg).
;b0      =eph(11)        ; Latitude at center of disk (deg).
;p       =eph(12)        ; Position angle of rotation axis (deg).
